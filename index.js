...
//  from inside a function is one of those things we would never want to do normally,
//  but is good for us to explore right now.
function setBestCustomer() {
    bestCustomer = 'not bob';
}

// overwriteBestCustomer(): See the consequences of declaring a variable in global scope, by writing a new 
...
//  in global scope called leastFavoriteCustomer; be sure to assign it some initial value. Finally,
//  write a function called changeLeastFavoriteCustomer() that attempts to change that constant - notice
//  what JavaScript does when you try to change the constant.
